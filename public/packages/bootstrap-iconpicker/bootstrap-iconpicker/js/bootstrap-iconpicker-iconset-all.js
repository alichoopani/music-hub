 ...
 * CDN: https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/[VERSION]/css/flag-icons.min.css
 * ======================================================================== */

;(function($){

    var data = {
        iconClass: 'flag-icons',
        iconClassFix: 'flag-icons-',
        icons: [],
        allVersions: [
            {
                version: '2.8.0',
