...
@section('content')
    ...
    <div class="sm:max-w-[82%] max-w-[95%] mx-auto py-6 mt-44 md:mt-0">
        <div class="flex items-center justify-between px-2 gap-4 flex-wrap">
            <div class="uppercase text-white text-lg sm:text-2xl md:text-3xl lg:text-4xl font-extrabold cursor-default">travel</div>
            <div class="flex">
                <div class="group">
                ...
                <div class="bg-[#303030] flex rounded-md">
                    ...
                    <div class="w-full flex flex-col justify-center text-white capitalize py-3 text-base font-semibold min-h-[6rem]">
                        ...
                        <div class=" capitalize text-sm text-[#989896] font-semibold">
                           <span class="paragraph-ellipsis-2 leading-snug ml-2">
                               <a class="hover:underline" href="{{route('artistDetail', ['id' => $item->id ."-". $item->title])}}">
                                   {{$item->artist->title}}</a>
                           </span>
                        </div>
                    </div>
    ...
    <div class="flex justify-center">
        {{ $travel->links('pagination::tailwind') }}
    </div>
    {{-- pagination ends--}}
